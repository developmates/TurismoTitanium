...
var vrTitle = '<strong>Dique La Angostura</strong>'; 
var vrSubTitle = ''; 
var vrDescription = 'Es un lago artificial ubicado a 2.000 metros de altura, ideal para la práctica de actividades náuticas (windsurf, remo, kayak, ski y jet ski), por lo que numerosas competiciones de Tucumán y de toda Argentina se desarrollan en el lago. También se practica la pezca de pejerreyes y truchas.'; 

/* --- START VIEW ------------------------------------ */
var startPan =280; 			/* left is negative, right is positive value */
var startTilt = 5; 		
