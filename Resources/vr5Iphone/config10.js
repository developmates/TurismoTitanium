...
var vrTitle = '<strong>Casa de Gobierno</strong>'; 
var vrSubTitle = ''; 
var vrDescription = 'La sede gubernamental es la máxima expresión de arquitectura francesa. Enciende sus luces por las noches con centenares de bombitas que la recortan en la noche tucumana.'; 

/* --- START VIEW ------------------------------------ */
var startPan =5; 			/* left is negative, right is positive value */
var startTilt = 0; 		
