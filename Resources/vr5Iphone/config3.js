...
var vrTitle = '<strong>Anfiteatro</strong>'; 
var vrSubTitle = ''; 
var vrDescription = 'El Cadillal con su embalse Celestino Gelsi es ideal para practicar deportes náuticos como esqui acuático, windsurf, remo, vela, etc., y para los amantes de la pesca. A orillas del Dique, se encuentra el anfiteatro de tipo romano para 800 personas, sirviendo para espectáculos al aire libre'; 

/* --- START VIEW ------------------------------------ */
var startPan =190; 			/* left is negative, right is positive value */
var startTilt = -2; 		
