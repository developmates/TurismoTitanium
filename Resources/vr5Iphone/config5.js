...
var vrTitle = '<strong>Raco</strong>'; 
var vrSubTitle = ''; 
var vrDescription = 'Es una pequeña villa, rodeada de hermosas colinas que se mezclan con las casonas residenciales. Se destaca por ser exclusivamente veraniega, dotada de un bello paisaje con bosques. Sus lomas cultivadas, arroyos plácidos y antiguas casas residenciales son parte de la historia tucumana. La capilla y la ermita a la Virgen de San Nicolás, marcan con un sello propio a la villa.'; 

/* --- START VIEW ------------------------------------ */
var startPan =220; 			/* left is negative, right is positive value */
var startTilt = -2; 		
