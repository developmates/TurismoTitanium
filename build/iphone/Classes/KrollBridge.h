...
@interface GuiaTuristicaObject : KrollCoverageObject {
#else
@interface GuiaTuristicaObject : KrollObject {
#endif
@private
...
extern NSString * GuiaTuristica$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GuiaTuristicaObject *_guiaturistica;
	BOOL shutdown;
