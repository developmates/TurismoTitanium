...
// in simulator we redefine to format for GuiaTuristica Developer console
...
{\
	NSString * exceptionName = [@"org.guiaturistica." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.guiaturistica";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGuiaTuristicaNativeItemNone = -1, 
	UIGuiaTuristicaNativeItemSpinner = -2,
	UIGuiaTuristicaNativeItemProgressBar = -3,
	
	UIGuiaTuristicaNativeItemSlider = -4,
	UIGuiaTuristicaNativeItemSwitch = -5,
	UIGuiaTuristicaNativeItemMultiButton = -6,
	UIGuiaTuristicaNativeItemSegmented = -7,
	
	UIGuiaTuristicaNativeItemTextView = -8,
	UIGuiaTuristicaNativeItemTextField = -9,
	UIGuiaTuristicaNativeItemSearchBar = -10,
	
	UIGuiaTuristicaNativeItemPicker = -11,
	UIGuiaTuristicaNativeItemDatePicker = -12,
	
	UIGuiaTuristicaNativeItemInfoLight = -13,
	UIGuiaTuristicaNativeItemInfoDark = -14,
	
	UIGuiaTuristicaNativeItemDisclosure = -15,
	
	UIGuiaTuristicaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GuiaTuristica instances of
