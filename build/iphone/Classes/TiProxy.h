...
//Rare exceptions to indicate a bug in the _guiaturistica code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GuiaTuristica proxies.
 */
