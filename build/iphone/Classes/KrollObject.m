 ...
 * Copyright (c) 2009-2011 by GuiaTuristica, Inc. All Rights Reserved.
...
//@interface GuiaTuristicaObject : NSObject
//@end

@interface GuiaTuristicaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GuiaTuristicaObject class]])
		{
			for (NSString *key in [[(GuiaTuristicaObject*)o modules] allKeys])
			{
