...
/**
 The base class for all GuiaTuristica modules
 */
...
/**
 GuiaTuristica Platform calls this method on startup.
 */
-(void)startup;

/**
 GuiaTuristica Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 GuiaTuristica Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 GuiaTuristica Platform calls this method on resume.
 @param sender The sender of the event.
 */
